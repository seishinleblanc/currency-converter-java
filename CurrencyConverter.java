...
public class CurrencyConverter {
    ...
    public static void Ruppe_to_other(double amt) {
        System.out.println("1 Ruppe = " + 0.013 + " Dollars");
        System.out.println();
        System.out.println(amt + " Ruppe = " + (amt * 0.013) + " Dollar");
        System.out.println();

        System.out.println("1 Ruppe = " + 0.012 + " Euros");
        System.out.println();
    ...
    public static void Dollar_to_other(double amt) {
        ...
        System.out.println("1 Dollar = " + 0.98 + " Euros");
        System.out.println();
    ...
    public static void Euro_to_other(double amt) {
        ...
        System.out.println("1 Euro = " + 1.02 + " Dollars");
        System.out.println();
